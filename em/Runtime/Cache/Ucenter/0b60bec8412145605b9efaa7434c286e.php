  		...
  		<div class="clearfix">
            	...
            	<div class="profile_box" id="basicInfo">
            		...
            		<div class="basicShow">
            			...
            			<div class="m_portrait">
	                    	<div></div>
	                    	<img width="120" height="120" alt="jason" src="/em/Public/style/images/default_headpic.png">
	                    </div>
            		</div><!--end .basicShow-->
            ...
            <div class="content_r">
				...
				<div class="greybg qrcode mt20">
                	<img width="242" height="242" alt="拉勾微信公众号二维码" src="/em/Public/style/images/qr_resume.png">
...
<div style="display:none;">
	...
	<div class="popup" id="uploadFile">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td align="center"><img width="55" height="16" alt="loading" style="visibility: hidden;" id="loadingImg" src="/em/Public/style/images/loading.gif"></td>
	        </tr>
	    </tbody></table>
	</div><!--/#uploadFile-->
...
<script src="/em/Public/style/js/Chart.min.js" type="text/javascript"></script>
<script src="/em/Public/style/js/profile.min.js" type="text/javascript"></script>
