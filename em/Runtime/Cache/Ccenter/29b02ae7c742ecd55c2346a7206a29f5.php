...
</script><script type="text/javascript" async="" src="/em/Public/style/js/conversion.js"></script><script src="/em/Public/style/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script><style type="text/css"></style>
...
<link href="/em/Public/style/css/style.css" type="text/css" rel="stylesheet">
<link href="/em/Public/style/css/external.min.css" type="text/css" rel="stylesheet">
<link href="/em/Public/style/css/popup.css" type="text/css" rel="stylesheet">
<script type="text/javascript" src="/em/Public/style/js/jquery.1.10.1.min.js"></script>
<script src="/em/Public/style/js/jquery.lib.min.js" type="text/javascript"></script>
<script type="text/javascript" src="/em/Public/style/js/ajaxfileupload.js"></script>
<script src="/em/Public/style/js/additional-methods.js" type="text/javascript"></script>
<!--[if lte IE 8]>
...
<script src="/em/Public/style/js/ajaxCross.json" charset="UTF-8"></script></head>
<body>
<div id="body">
	<div id="header">
    	<div class="wrapper">
    ...
    <div id="container">
  		...
  		<div style="" id="stepTip">
       		<a></a>
       		<img width="803" height="59" src="/em/Public/style/images/tiponce.jpg">
       	</div>
                ...
                <dd>
	                <form id="stepForm">
	                	<div class="c_text_1">基本信息为必填项，是求职者加速了解公司的窗口，认真填写吧！</div>
	                 	<img width="668" height="56" class="c_steps" alt="第一步" src="/em/Public/style/images/step1.png">
	                    
	                    <h3>公司全称 </h3>
	                    <input type="text" placeholder="请输入公司名称，如:百度科技有限公司" value="" name="cname" id="cname" class="valid">	
		...
		<object width="650" height="470" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="FlashID">
		  ...
		  <object width="650" height="470" data="../../flash/avatar.swf?url=http://www.lagou.com/cd/saveProfileLogo.json" type="application/x-shockwave-flash">
		    ...
		    <div>
		      ...
		      <p><a href="http://www.adobe.com/go/getflashplayer"><img width="112" height="33" src="/em/Public/style/images/get_flash_player.gif" alt="获取 Adobe Flash Player"></a></p>
		    </div>
		    <!--[if !IE]>-->
		  </object>
		  <!--<![endif]-->
...
<script src="/em/Public/style/js/step1.min.js" type="text/javascript"></script>
<script>
var avatar = {};
