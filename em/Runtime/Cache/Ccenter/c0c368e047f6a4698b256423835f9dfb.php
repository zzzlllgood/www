	...
	<dd>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
			                                ...
			                                <div class="resumeShow">
			                                    	...
			                                    	<img src="/em/Public/style/images/default_headpic.png">
			                                    </a>
...
<!------------------------------------- end -----------------------------------------> <script src="/em/Public/style/js/jquery.ui.datetimepicker.min.js" type="text/javascript"></script>
<script src="/em/Public/style/js/received_resumes.min.js" type="text/javascript"></script> 
<script>
</script>  
			<div class="clear"></div>
