...
<script type="text/javascript" async=""
	src="/em/Public/style/js/conversion.js"></script>
<script src="/em/Public/style/js/allmobilize.min.js" charset="utf-8"
...
<link href="/em/Public/style/css/style.css" type="text/css"
	rel="stylesheet">
<link href="/em/Public/style/css/external.min.css" type="text/css"
	rel="stylesheet">
<link href="/em/Public/style/css/popup.css" type="text/css"
	rel="stylesheet">
<script type="text/javascript"
	src="/em/Public/style/js/jquery.1.10.1.min.js"></script>
<script src="/em/Public/style/js/jquery.lib.min.js"
	type="text/javascript"></script>
<script type="text/javascript"
	src="/em/Public/style/js/ajaxfileupload.js"></script>
<script src="/em/Public/style/js/additional-methods.js"
	type="text/javascript"></script>
<!--[if lte IE 8]>
    <script type="text/javascript" src="/em/Public/style/js/excanvas.js"></script>
<![endif]-->
<script type="text/javascript">
var youdao_conv_id = 271546; 
</script>
<script src="/em/Public/style/js/conv.js" type="text/javascript"></script>
<script src="/em/Public/style/js/ajaxCross.json" charset="UTF-8"></script>
<style type="text/css">
.BMap_mask {
	background: transparent url(/em/Public/style/images/img/blank.gif);
}
...
.BMap_zoomer {
	background-image: url(/em/Public/style/images/img/mapctrls1d3.gif);
...
.BMap_stdMpPan {
	...
	height: 44px;
	overflow: hidden;
	background: url(/em/Public/style/images/img/mapctrls2d0.png) no-repeat;
}
...
.BMap_ie6 .BMap_smcbg {
	...
	width: 44px;
	height: 464px;
	filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="/em/Public/style/images/img/mapctrls2d0.png");
}
...
.BMap_stdMpZoom .BMap_button {
	...
	left: 12px;
	overflow: hidden;
	background-image: url(/em/Public/style/images/img/mapctrls2d0.png);
	background-repeat: no-repeat;
	z-index: 10;
}
...
.BMap_stdMpType4 .BMap_smcbg {
	position: static;
	background: url(/em/Public/style/images/img/mapctrls2d0_mb.png) 0 0
		no-repeat;
...
.BMap_stdMpSliderBar {
	...
	top: 80px;
	overflow: hidden;
	background: url(/em/Public/style/images/img/mapctrls2d0.png) no-repeat 0
		-309px;
}
...
.BMap_omBtn {
	...
	cursor: pointer;
	overflow: hidden;
	background: url(/em/Public/style/images/img/mapctrls1d3.gif) no-repeat;
	z-index: 1210;
}
...
.BMap_checkbox {
	background: url(/em/Public/style/images/img/mapctrls1d3.gif);
...
.BMap_vectex_nodeT {
	background-image: url(/em/Public/style/images/img/nodeT.gif);
}

.BMap_vectex_node {
	background-image: url(/em/Public/style/images/img/node.gif);
}
...
.iw_search, .iw_l {
	background:
		url("/em/Public/style/images/img/u20LgruGtNFM8lqnNtfK2JqN3CVeW1gzWj9jThd0xd59R8BBgAAiefGO1Bt1gAAAABJRU5ErkJggg==")
		no-repeat 50% 50%;
...
.iw_line_s, .iw_r {
	background:
		url("/em/Public/style/images/img/wCKLRHq20vjSoVNKWunH4rTBDv5Cv7NKeKfvvU2nINzHAuexzUA7KQTkoB6UxDicKvcqfQQYABaiUBxugCsr20AAAAAElFTkSuQmCC")
		no-repeat 50% 50%;
	-webkit-background-size: 19px 19px;
}
...
.route_tip_con .route_tip span {
	...
	width: 14px;
	height: 13px;
	background: url(/em/Public/style/images/img/addrPage.png) no-repeat 0
		-121px;
	cursor: pointer;
}
...
.sel_n .sel_top {
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat 0 -418px;
	height: 4px;
	font-size: 0px;
}
...
.sel_n .sel_body_sign {
	...
	height: 31px;
	float: left;
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat -79px
		-387px;
}
...
.sel_n .sel_bottom {
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat 0 -415px;
	height: 4px;
	font-size: 0px;
}
...
.sel_n1 .sel_body_top {
	height: 31px;
	width: 100%;
	background: url(/em/Public/style/images/img/sel_body_n_top.gif) repeat-x;
}
...
.sel_n1 .sel_body_button {
	...
	height: 31px;
	margin-left: -23px;
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat -253px
		-382px;
	overflow: hidden;
	zoom: 1;
	cursor: pointer;
...
.sel_y .sel_top {
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat 0 -439px;
	height: 4px;
	zoom: 1;
	font-size: 0px;
}
...
.sel_y .sel_body_top {
	height: 32px;
	width: 100%;
	background: url(/em/Public/style/images/img/addrPage.png) no-repeat 0 0
}
...
.sel_y .sel_body_sign {
	...
	height: 31px;
	float: left;
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat -167px
		-384px;
}
...
.sel_y .sel_body_button {
	...
	height: 31px;
	margin-left: -20px;
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat -269px
		-297px;
	cursor: pointer;
}
...
.sel_y .sel_bottom {
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat 0 -436px;
	height: 4px;
	font-size: 0px;
}
...
.sel_x .sel_body_sign {
	...
	height: 31px;
	float: left;
	background: url(/em/Public/style/images/img/bgs.gif) no-repeat -122px
		-384px;
}
...
.sel_body_resitem th div.iconbg {
	background: url(/em/Public/style/images/img/markers_new_ie6.png)
...
.sel_body_resitem td .selBtn {
	width: 70px;
	height: 29px;
	background: url(/em/Public/style/images/img/addrPage.png) no-repeat
		-21px -81px;
	text-align: center;
	line-height: 29px;
	visibility: hidden;
...
<link rel="stylesheet" href="/em/Public/style/css/ui.css">
<link rel="stylesheet" href="/em/Public/style/css/window.css">
</head>
<body>
<div id="body">
	<div id="header">
    	<div class="wrapper">
    		<a class="logo" href="index.html">
    			<img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="/em/Public/style/images/logo.png">
    		</a>
    ...
    <div id="container">
		...
		<dt>我收到的简历</dt>
		<dd>
		<a href="canDealResumes.html">待处理简历</a> 
			</dd>
	<dd>
...
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
			<dd>
		<a href="positionsOn.html">有效职位</a>
	</dd>
	<dd>
		<a href="positionsOff.html">已下线职位</a>
	</dd>
	</dl>
...
<!-- old -->
<script src="/em/Public/style/js/jquery.tinymce.js" type="text/javascript"></script>
<script>
$(function(){
...
<script src="/em/Public/style/js/jobs.min.js" type="text/javascript"></script>
...
<script src="/em/Public/style/js/core.min.js" type="text/javascript"></script>
<script src="/em/Public/style/js/popup.min.js" type="text/javascript"></script>
