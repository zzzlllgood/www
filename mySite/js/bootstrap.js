...
+function(a) {
    ...
    c.prototype.slide = function(b, d) { 
        ...
        if (this.$element.trigger(k), !k.isDefaultPrevented()) {
            ...
            g && this.cycle()||!a.support.transition&&(this.$element.hasClass("slide") ? (this.$element.find(".item").css({"display":"block","float":"left"}),this.$element.find(".carousel-inner").css({"width":5000}).animate({
                left: h=="left"?e.index()==this.$element.find(".item").length-1?0:-(e.index()+1)*e.outerWidth(true):e.index()==0?(1-this.$element.find(".item").length)*e.outerWidth(true):-(e.index()-1)*e.outerWidth(true)},1000,"linear",function() {
